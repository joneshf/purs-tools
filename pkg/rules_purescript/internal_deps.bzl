"""
Dependencies used internally that also need to be loaded if building the PureScript `gazelle` `Language`.

This file is automatically updated by `make gazelle-update-repos`.
DO NOT EDIT BY HAND.
"""
...
def go_dependencies():
    """
    These dependencies are automatically updated by `make gazelle-update-repos`.
